...
/// Canonicalizes detector evidence at the single review boundary.
///
...
) => List<MedicineFrameEvidence>.unmodifiable(
  source.map(_normalizeMedicineReviewFrame),
);

MedicineFrameEvidence _normalizeMedicineReviewFrame(
